            ...
            <div class="col-xs-12">
                    ...
                    <div class="card-deck">
                        <a class="card card-inverse card-primary text-xs-center" href="{{ route('news_index_path') }}">
                            <div class="card-block">
                                ...
                                <p class="card-text">View the paginated news articles. This is set to 5 by default. See
                                    'app/Http/Controllers/ArticleController.php'.</p>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <a class="card card-inverse card-info text-xs-center" href="{{ route('installation_path') }}">
                    <div class="card-block">
                        ...
                        <p class="card-text">Shows the installation page. If you can read this. You've already
                            made
                            it.</p>
                    </div>
                </a>
                ...
                <div class="card-deck-wrapper">
                    <div class="card-deck">
                        ...
                        <a class="card card-inverse card-success text-xs-center" href="/sql/city_am_sql_dump.sql">
                            <div class="card-block">
                                <h1 class="card-title display-4">SQL</h1>
                                <p class="card-text">Download a SQL Dump to import into the Database for sample data.</p>
                            </div>
                        </a>
                    </div>
                </div>
